// Web-specific App - uses createBrowserRouter instead of createMemoryRouter
...
const router = createBrowserRouter([
  ...
  },
  {
    ...
    element: <DetailPage />,
    children: [
      { path: CONST.ROUTES.DETAIL_FUND, element: <DetailFundPage /> },
      { path: CONST.ROUTES.DETAIL_ZINDEX, element: <DetailZindexPage /> },
      { path: CONST.ROUTES.DETAIL_QUOTATION, element: <DetailQuotationPage /> },
      { path: CONST.ROUTES.DETAIL_STOCK, element: <DetailStockPage /> },
      { path: CONST.ROUTES.DETAIL_COIN, element: <DetailCoinPage /> },
      { path: CONST.ROUTES.DETAIL_WEBVIEWER, element: <WebViewerPage /> },
    ],
  },
]);
